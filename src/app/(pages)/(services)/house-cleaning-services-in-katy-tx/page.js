import HouseCleaningServicesInKatyTX from '@/components/HouseCleaningServicesInKatyTX/HouseCleaningServicesInKatyTX';
...
export async function generateMetadata() {
    ...
    try {
        ...
        const metaDataResponse = await fetch(`${apiUrl}/api/metaDatas?pageName=${pageName.HOUSE_CLEANING_SERVICES_IN_KATY_TX}`, {
            cache: "no-store",
        });
