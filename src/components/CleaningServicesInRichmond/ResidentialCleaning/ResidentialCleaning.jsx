      ...
      <div className="container padding__top">
        <div className="grid md:grid-cols-6 grid-cols-1  gap-10">
          ...
          <div className="md:col-span-3">
            ...
            <h3 className="text-black text-[32px] md:text-[33px] lg:text-[34px] xl:text-[36px] 2xl:text-[38px] 3xl:text-[40px] 4xl:text-[41px] 5xl:text-[42px] font-bold  text-center md:text-left pt-[10px] py-3">Residential Cleaning Services Richmond</h3>
            ...
            <div className=" mt-[40px] grid md:grid-cols-2 grid-cols-1 gap-[13px]">
              <div className="flex flex-col items-center justify-center ">
                ...
                <h6 className="text-center text-[#880769] text-lg font-bold">Regular housekeeping</h6>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center mt-[30px] md:mt-0">
                ...
                <h6 className="text-center text-[#880769] text-lg font-bold">Deep cleaning</h6>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center mt-[30px]">
                ...
                <h6 className="text-center text-[#880769] text-lg font-bold">Move-in/move-out cleaning</h6>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center mt-[30px]">
                ...
                <h6 className="text-center text-[#880769] text-lg font-bold">Post-renovation cleaning</h6>
                </div>
              </div>
