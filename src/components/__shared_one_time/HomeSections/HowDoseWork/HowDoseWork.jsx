    ...
    <div className="bg-white py-[25px] xl:py-[30px] 5xl:py-[35px]">
      <div data-aos="zoom-in" className="container ">
        ...
        <HeadingIcon text={headingIconText.howDoesWork__headingIconText}/>
          ...
          <p className="text-base 4xl:text-[17px] 5xl:text-lg font-normal text-dark leading-[30px] 5xl:leading-[36px] text-center">At Maricela's Cleaning Magnificence, we've streamlined our process to provide hassle-free and efficient cleaning services Let Maricela's Cleaning Magnificence transform your space into a clean, organized, and welcoming environment. Contact us today to schedule your service and experience the difference between working with a cleaning company that truly cares!</p>
        </div>
