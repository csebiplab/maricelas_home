...
import "./HouseCleaningServicesBanner.css";

const HouseCleaningServicesBanner = () => {
  return (
    <>
        ...
        <div className="md:flex items-center relative">
          <div className="w-full md:w-[58%]">
            <div className="py-14 md:py-0 px-4 md:pl-0">
              ...
              House Cleaning Services <br />{" "}
                <span className="text-primary">in Katy TX</span>
              </h1>
              <p className="text-lg font-normal mb-5 leading-6 mt-4 text-black">
              Discover top-notch house cleaning services in Katy, TX, tailored to meet your unique needs with our professional cleaners.
              </p>
          ...
          <div className="hero-right relative hidden md:block">
            <Image
              width={928}
              height={782}
              src="/assets/houseCleaningServices/hero-bg.jpg"
...
export default HouseCleaningServicesBanner;
