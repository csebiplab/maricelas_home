    ...
    <div>
      <div className="">
        <div className="grid lg:grid-cols-10 md:grid-cols-7 custom-container  lg:relative  ">
          ...
          {/* contact part */}
          <div className=" lg:absolute md:col-span-3 md:order-1 flex justify-center Fitems-center  text-center  lg:left-[16%] xl:left-[20%] 2xl:left-[40%] 4xl:left-[40%] 2xl:top-[20%] lg:top-[20%]  bg-[#880769] 2xl:my-16 my-8  2xl:py-8 py-5 border shadow-md rounded-md border-black z-50  ">
            <div className=''>
