  ...
  return (
    <div className="custom-container px-5 lg:px-0">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-[49px] my-[120px]">
        ...
        <div className="border border-red-500 pr-3 md:pr-5 lg:pr-10 xl:pr-20 2xl:pr-28 3xl:pr-40 4xl:pr-52 5xl:pr-[285px]">
          <div className="border border-red-500">
            <div className="flex flex-col lg:flex-row w-full border border-red-500 lg:relative">
              ...
              <div className="ml-24">
                <div>
                  <div className="grid grid-cols-11">
                    ...
                    <div className="w-full lg:col-span-4 border border-red-600 flex justify-center">
                      <div className="">
                        <Image
                          src={author}
                          width={157}
                          height={157}
                          alt="author"
                          className="lg:mb-4 mb-2 w-full lg:w-[157px] lg:h-[157px]"
                        />
                        <h5 className="py-1 lg:text-base text-sm">
                          Maricela Maldonado
                        </h5>
                        <p className="lg:text-base text-xs">General Manager</p>
                      </div>
                    </div>
                  </div>

                  <p className="leading-[250%] mt-4">
