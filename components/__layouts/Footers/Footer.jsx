  ...
  return (
    <div className="">
      ...
      <div className="  footer-bottom-bg    ">
        <section className=" grid lg:grid-cols-7 gap-5 lg:py-6 xs:py-2   items-center  md:mx-auto text-center ">
          <div className=" lg:col-span-3 flex items-center xs:justify-center lg:justify-normal gap-2  ">
            ...
            <Image src={gokundo} alt="gokundo" width={"160px"} height={"40px"} className=" ml-2 " />
          </div>
